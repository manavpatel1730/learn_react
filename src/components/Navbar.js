                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form className="d-flex">
                            {/* <div className="form-check form-switch">
                                <input className="form-check-input" onClick={props.toggleRedGreen} type="checkbox" id="flexSwitchCheckDefault" />
...
Navbar.defaultProps = { title: "Set title here", about: "About TextUtiles" }
